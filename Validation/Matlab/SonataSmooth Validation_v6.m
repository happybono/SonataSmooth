...
alpha = 1.0;                % used for BinomAvg / BinomWMedian / GaussWMedian / Gauss only

sigmaFactor = 6.0;          % ApplySmoothing default when sigmaFactor is omitted

polyOrder  = 2;
derivOrder = 1;             % ApplySmoothing parity only (SG smoothing only)
...
% writetable(T, 'MATLAB_Result_Adaptive_3.csv', ...
%    'Delimiter', ',', ...
%    'WriteVariableNames', true);

% Verification (Optional)
% disp("Saved: MATLAB_Result_Adaptive_3.csv");
